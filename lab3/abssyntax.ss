...
(define (dolist-parameters exp)
  (cadr exp))

(define (dolist-variable exp)
  (car (dolist-parameters exp)))

(define (dolist-listexpr exp)
  (cadr (dolist-parameters exp)))

(define (dolist-resultvar exp)
  (caddr (dolist-parameters exp)))

(define (dolist-body exp)
  (cddr exp))

;; Selection (%cons-stream)
;; ------------------------

(define (stream-head exp)
  (cadr exp))

(define (stream-tail exp)
  (caddr exp))
